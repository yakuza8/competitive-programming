...
class Solution:
    ...
    def maxProfit(prices: List[int]) -> int:
        ...
        find the maximum profit. You may complete as many transactions as you like (i.e., buy one and sell one share of
...
class MaxProfit(unittest.TestCase):
    ...
    def test_case_1(self):
        prices = [7, 1, 5, 3, 6, 4]
        expected_result = 7
        self.assertEqual(expected_result, Solution.maxProfit(prices))
