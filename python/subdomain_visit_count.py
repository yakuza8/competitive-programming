...
class Solution:
    ...
    def subdomainVisits(cpdomains: List[str]) -> List[str]:
        ...
        "9001 discuss.leetcode.com". We are given a list cpdomains of count-paired domains. We would like a list of
        count-paired domains, (in the same format as the input, and in any order), that explicitly counts the number of
        ...
        for cpdomain in cpdomains:
            ...
            for i in range(len(subdomains)):
                visit_counts['.'.join(subdomains[:i + 1][::-1])] += count

        return [str(_count) + " " + _domain for _domain, _count in visit_counts.items()]


class SubdomainVisitCount(unittest.TestCase):

    def test_case_1(self):
        cpdomains = ["9001 discuss.leetcode.com"]
        expected_output = ["9001 discuss.leetcode.com", "9001 leetcode.com", "9001 com"]
        self.assertSetEqual(set(expected_output), set(Solution.subdomainVisits(cpdomains)))

    def test_case_2(self):
        cpdomains = ["900 google.mail.com", "50 yahoo.com", "1 intel.mail.com", "5 wiki.org"]
        expected_output = ["901 mail.com", "50 yahoo.com", "900 google.mail.com", "5 wiki.org", "5 org",
